...
class TextToConsensusClassificationConverterTest {
  ...
  void convertLikelyBenign() throws CsvDataTypeMismatchException {
    assertEquals(ConsensusClassification.LIKELY_BENIGN, textToConsensusClassificationConverter.convert("(Likely) benign"));
  }

  @Test
  void convertVus() throws CsvDataTypeMismatchException {
    assertEquals(ConsensusClassification.VUS, textToConsensusClassificationConverter.convert("VUS"));
  }

  @Test
  void convertLikelyPathogenic() throws CsvDataTypeMismatchException {
    assertEquals(ConsensusClassification.LIKELY_PATHOGENIC, textToConsensusClassificationConverter.convert("(Likely) pathogenic"));
  }

  @Test
  void convertClassifiedByOneLab() throws CsvDataTypeMismatchException {
    assertEquals(ConsensusClassification.CLASSIFIED_BY_ONE_LAB, textToConsensusClassificationConverter.convert("Classified by one lab"));
  }

  @Test
  void convertNoConsensus() throws CsvDataTypeMismatchException {
    assertEquals(ConsensusClassification.NO_CONSENSUS, textToConsensusClassificationConverter.convert("No consensus"));
  }

  @Test
  void convertUnknownConsensusClassification() throws CsvDataTypeMismatchException {
